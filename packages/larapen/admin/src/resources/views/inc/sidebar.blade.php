	...
	<aside class="main-sidebar" id="adminSidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					<a href="#"><i class="fa fa-bolt"></i> <span>Promotion</span> <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="{{ url($adminBase . '/package') }}"><i class="fa fa-star"></i> <span>{{ __t('packages') }}</span></a></li>
						<li><a href="{{ url($adminBase . '/requestedpromotion') }}"><i class="fa fa-star"></i> <span>Requested</span></a></li>
					</ul>
				</li>
				<li class="treeview">
					<a href="#"><i class="fa fa-usd"></i> <span>Stores</span> <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="{{ url($adminBase . '/openstore') }}"><i class="fa fa-table"></i> <span>Store Request</span></a></li>
						<li><a href="{{ url($adminBase . '/allstores') }}"><i class="fa fa-table"></i> <span>All Stores</span></a></li>
