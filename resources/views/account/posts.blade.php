									...
									<tr>
										...
										<td style="width:58%" class="ads-details-td">
											<div>
												...
												<p>
													...
													@endif
													@if($post->featured==1 && $post->topad==1)
													@php
													$tpack=App\Models\BPackage::find(2);
													@endphp
														<span class="ads-icon" >
														<a  data-toggle="tooltip" data-placement="top" title="Topad" ><img width="35" src="{{asset('uploads/'.$tpack->picture)}}"></a>
													</span>
													@endif
													@if($post->featured==1 && $post->bumpad==1)
													@php
													$bpack=App\Models\BPackage::find(3);
													@endphp
														<span class="ads-icon" >
														<a data-toggle="tooltip" data-placement="top" title="Bump up"><img width="35"  src="{{asset('uploads/'.$bpack->picture)}}"></a>
													</span>
													@endif
													@if($post->featured==1 && $post->spotlight==1)
													@php
													$spack=App\Models\BPackage::find(1);
													@endphp
														<span class="ads-icon" >
														<a data-toggle="tooltip" data-placement="top" title="Spotlight"><img width="35" src="{{asset('uploads/'.$spack->picture)}}"></a>
													</span>
													@endif
												</p>
											</div>
										...
										<td style="width:10%" class="action-td">
											<div>
                                                ...
                                                <p>
                                                	<a href="{{ lurl(slugify($post->title). '/' .$post->id. '/'.'promote') }}" class="btn btn-default btn-sm">Promote</a>
                                                </p>
											</div>
										</td>
									</tr>
