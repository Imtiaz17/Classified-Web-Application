		...
		<div class="user-panel-sidebar">
			...
			<div class="collapse-box">
				...
				<div class="panel-collapse collapse in" id="MyClassified">
					<ul class="acc-list">
						<li>
							<a class="{{ (request()->is('account')) ? 'active' : '' }}" href="{{ lurl('account') }}">
				...
				<div class="panel-collapse collapse in" id="MyClassified">
					<ul class="acc-list">
						<li>
							<a class="{{ (request()->is('my-store')) ? 'active' : '' }}"  href="{{url('my-store') }}">
								<i class="icon-home"></i>My store
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="panel-collapse collapse in" id="MyClassified">
					<ul class="acc-list">
						<li>
							<a class="{{ (request()->is('get-membership')) ? 'active' : '' }}"  href="{{url('get-membership') }}">
								<i class="icon-home"></i>Become a member
							</a>
						</li>
					</ul>
				</div>
