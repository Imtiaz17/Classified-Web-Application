							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab-details">
									<div class="row" style="padding: 10px;">
										<div class="ads-details-info col-md-8 col-sm-8 col-xs-12 enable-long-words from-wysiwyg">
											<h4><i class="icon-doc-text"></i> {{ t('Description') }}:</h4>
										...
										<div class="col-md-4">
											...
											<!-- Location -->
											<p>
											<strong><i class="fa fa-map-marker"></i> {{ t('Location') }}: </strong>
											...
											<!-- Actions -->
											<div class="detail-line-action row text-center">
													...
													<a class="make-favorite" id="{{ $post->id }}">
														@if (Auth::check())
															@if (\App\Models\SavedPost::where('user_id', $user->id)->where('post_id', $post->id)->count() > 0)
																<i style="margin-top: 6px;" class="fa fa-heart tooltipHere" data-toggle="tooltip" data-original-title="{{ t('Remove favorite') }}"></i>
															@else
																<i style="margin-top: 6px;" class="fa fa-heart-o" class="tooltipHere" data-toggle="tooltip" data-original-title="{{ t('Save ad') }}"></i>
															@endif
														@else
															<i  style="margin-top: 6px;"class="fa fa-heart-o" class="tooltipHere" data-toggle="tooltip" data-original-title="{{ t('Save ad') }}"></i>
														@endif
												...
												<div class="col-md-4 col-sm-4 col-xs-4">
													<a href="{{ lurl('posts/' . $post->id . '/report') }}">
														<i style="margin-top: 6px;" class="fa icon-info-circled-alt tooltipHere" data-toggle="tooltip" data-original-title="{{ t('Report abuse') }}"></i>
													</a>
												</div>
											</div>
											...
											<a href="{{ lurl(slugify($post->title). '/' .$post->id. '/'.'promote') }}" class="btn btn-default">Promote this ad</a>
										</div>
